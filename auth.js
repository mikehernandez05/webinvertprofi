...
(function () {
  ...
  // Modo desarrollo: si estamos en localhost, no requerir auth
  ...
  if (host === 'localhost' || host === '127.0.0.1' || host === '0.0.0.0') {
    ...
    window.AUTH = {
      ...
      getUser: function () { return { uid: 'dev-user', email: 'dev@test.com', displayName: 'Developer' }; },
      getUID: function () { return 'dev-user'; },
